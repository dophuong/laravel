                ...
                <div class="panel-body">
                    <form enctype="multipart/form-data" class="form-horizontal" role="form" method="POST" action="{{ route('userAddPost') }}">
                        ...
                        <div class="form-group{{ $errors->has('content') ? ' has-error' : '' }}">
                            <label for="content" class="col-sm-4 col-md-4 control-label">Content</label>
                            <div class="col-sm-6 col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
                            <label for="image" class="col-sm-4 col-md-4 control-label">Image</label>
                            <div class="col-sm-6 col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('isPrivate') ? ' has-error' : '' }}">
                            <label for="isPrivate" class="col-sm-4 col-md-4 control-label">Is Private</label>
                            <div class="col-sm-6 col-md-6">
